    ...
    !function () {
        ...
        s.setPath('https://dup.baidustatic.com/'), s.define({
            ...
            off: function (t, e, i) {
                ...
                if (e.indexOf("on") && (e = "on" + e), "undefined" == typeof i) delete s[e]; else if (o = s[e]) for (n = o.length - 1; n >= 0; n--) o[n].handler === i && o.splice(n, 1);
                return t
            },
            ...
            loadAntiBotFile: function () {
                ...
                500 > t && setTimeout(function () {
                    ...
                    t.type = "text/javascript", t.async = !0, t.src = "https://cpro.baidustatic.com/cpro/ui/ab.min.js";
            ...
            name: "slot", namespace: "dup.business", deps: {
                config: "dup.common.config",
                ...
                var i, n;
                t.posUrl && (this.browser.antBrowser || t.proxy) ? (t.paramObj.ctxant = "1", i = this.param.getParamString(t.paramObj), n = t.posUrl + i) : (i = this.param.getParamString(t.paramObj), n = this.config.POS_URL + i), t.paramObj.dtm = this.config.HTML_POST, t.timestampWatcher.t2 = +new Date;
                var o = !1;
                "union" === t.productLine && (o = !0), t.isAsync === !0 && (o = !0), e = this.reqLocalInfo(t), e ? (this.setStatus(t.id, this.config.STATUS_REQUEST), window[this.config.LOADER_DEFINE_NAME](e)) : (this.sendJsonpRequest(n, o), this.setStatus(t.id, this.config.STATUS_REQUEST))
            }, onMessageHandler: function (t) {
                var e = t.data;
                if (e && e.tuid) {
                    var i = t.origin || t.originalEvent.origin, n = i && i.split("//")[1], o = t.source;
                    if (e.placement && e.placement.update && e.queryid) this.updateInfo(e), e.tuid.indexOf("u") > -1 && e.noadx && parseInt(e.noadx, 10) && 3 !== parseInt(e.noadx, 10) && this.unionAdIsAvailable(e); else if (1 === e.type && n && o && o.parent === window) {
                ...
                var e = t.response;
                if (!e) return !0;
                var i = e.pdb_deliv, n = e.rtb_deliv, o = e.order_deliv, s = e.pdb_deliv.deliv_des,
                ...
                e.cname = n.cname;
                var o = this.dom.g(t.containerId), s = i.container, r = s.sizeType, a = s.width, d = s.height,
                    l = {width: o.parentElement.clientWidth || 0, height: o.parentElement.clientHeight || 0};
                if (t.styleOpenApi) {
                    ...
                    var u = c.cpro_w || c.rsi0 || 0, p = c.cpro_h || c.rsi1 || 0;
                    (u || p) && (r = 1, a = u || this.getCurViewportWidth(a), d = p || d)
                }
                return ("-1" === t.pcwd || t.ftpc || t.styleOpenApi.cpro_ftpc) && (r = "-1" === t.pcwd && "-1" === t.pchd ? 8 : 5), 1 === r ? e = {
                    width: a,
                    height: d
                    ...
                    width: l.width || 0,
                    height: l.height || 0
                }), e.sizeType = r, t.width = e.width, t.height = e.height, e
            }
        }), s.define({
            name: "detect",
            namespace: "dup.business",
            ...
            processFrameData: function (t) {
                ...
                var m = {};
                return m.iframeId = t.iframeId, m.srcAttriName = "src", m.onloadDefine = n, m.iframeWidth = "" + d, m.iframeHeight = "" + l, m.url = e, m
            },
            ...
            render: function (t) {
                ...
                if (e) {
                    ...
                    e.innerHTML = d, window.location.href.indexOf("DUP_DEBUG_FLAG") > -1 && this.style.getDebugStyle(e), t.isPdbAd || this.slot.setStatus(t.id, this.config.STATUS_FINISH)
                }
            }
        }), s.define({
            name: "float",
            ...
            containerFilter: function (t) {
                var e = !1, i = t.response.placement, n = i.container, o = n.location;
                if (2 === o) return !1;
                var s = 3.4;
                if (1 !== n.sizeType) {
                ...
                if (t.styleOpenApi) {
                    ...
                    if (t.styleOpenApi.scale) {
                        var l = t.styleOpenApi.scale.split("."), c = l[0] / l[1];
                        e = !(s > c)
                    }
                }
                return e
            ...
            processSlotInfo: function (t) {
                ...
                var a = i.location;
                return 2 !== a && 3 !== a && (a = 3), r.locationType = a, r.containerId = t.containerId, r.closeType = i.closeType, r
            },
            parseHtmlSnippet: function (t) {
            ...
            parseCloseBtnLayoutData: function (t) {
                var e = 16, i = window.devicePixelRatio || 1, n = t.width / t.height,
            ...
            closeBtnOnClickHandler: function (t, e) {
                ...
                if (i && i.parentNode && i.parentNode.removeChild(i), 2 === e.closeType) {
                    var n = "bd_close_" + this.id, o = {path: ""};
                ...
                if (this.validate(e)) {
                    ...
                    if (!i) {
                        ...
                        if (n && (t.width = e.width, t.height = e.height, this.containerFilter(t))) {
                            ...
                            n.innerHTML = l, window.location.href.indexOf("DUP_DEBUG_FLAG") > -1 && this.style.getDebugStyle(n);
                            var c = this.dom.g(t.containerId + "_closebtn");
                            c && this.dom.bind(c, "click", s.proxy(this, this.closeBtnOnClickHandler, t)), this.hiddenFloatAd.render(t), t.isPdbAd || this.slot.setStatus(t.id, this.config.STATUS_FINISH)
                        }
                    }
                }
            }
            ...
            render: function (t) {
                ...
                if (n && (this.expand.observer(t), this.bindEvent4Expand(t)), this.validate(t)) {
                    ...
                    e.innerHTML = a, window.location.href.indexOf("DUP_DEBUG_FLAG") > -1 && this.style.getDebugStyle(e), this.viewWatch.regisetViewWatch(t), t.isPdbAd || this.slot.setStatus(t.id, this.config.STATUS_FINISH), n && setTimeout(function () {
                        s.expand.fire("adloaded", t.id)
                    }, 800)
                }
            }
